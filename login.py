...
st.markdown("<style>[data-testid='stSidebarNav'] { display: none; } [data-testid='collapsedControl'] { display: none; } section[data-testid='stSidebar'] { display: none; } header[data-testid='stHeader'] { display: none !important; }</style>", unsafe_allow_html=True)
